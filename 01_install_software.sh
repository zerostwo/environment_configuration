...
mamba create -p ${WORKING_DIR}/falco/1.2.3 -c bioconda falco=1.2.3 -y
...
mamba create -p ${WORKING_DIR}/stringtie/2.2.3 -c bioconda stringtie=2.2.3 -y
mamba create -p ${WORKING_DIR}/salmon/1.10.3 -c bioconda salmon=1.10.3 -y
mamba create -p ${WORKING_DIR}/kallisto/0.51.0 -c bioconda kallisto=0.51.0 -y
...
# -----------------------------------------------------------------------------
# Others
mamba create -p ${WORKING_DIR}/multiqc/1.23 -c bioconda multiqc=1.23 -y
mamba create -p ${WORKING_DIR}/bedtools/2.31.1 -c bioconda bedtools=2.31.1 -y
mamba create -p ${WORKING_DIR}/samtools/1.20 -c bioconda samtools=1.20 -y
mamba create -p ${WORKING_DIR}/snakemake/8.18.0 -c bioconda snakemake=8.18.0 -y
mamba create -p ${WORKING_DIR}/sambamba/1.0.1 -c bioconda sambamba=1.0.1 -y
mamba create -p ${WORKING_DIR}/picard/3.2.0 -c bioconda picard=3.2.0 -y
