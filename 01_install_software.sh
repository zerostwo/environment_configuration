...
# -----------------------------------------------------------------------------
# Others
mamba create -p ${WORKING_DIR}/multiqc/1.17 -c bioconda multiqc=1.17 -y
mamba create -p ${WORKING_DIR}/bedtools/2.31.0 -c bioconda bedtools=2.31.0 -y
mamba create -p ${WORKING_DIR}/samtools/1.18 -c bioconda samtools=1.18 -y
...
mamba create -p ${WORKING_DIR}/meme/5.5.4 -c bioconda meme=5.5.4 -y
